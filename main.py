...
# --- 1. የቦት ቅንብሮች (TOKEN, ADMINS & FEES) ---
BOT_TOKEN = "8220259287:AAGx33SXqUSG7Ik6Oa69orMwcynPdXzuadQ"
...
@flask_app.route('/')
def index():
    return "🚀 Live CBE Bot with Back Button running from main.py!"
...
def handle_callbacks(call):
    ...
    if call.data.startswith("set_lang_"):
        lang = "am" if call.data == "set_lang_am" else "en"
        session["lang"] = lang
        ...
        bot.send_message(chat_id, welcome_text, reply_markup=get_main_keyboard(lang))
...
if __name__ == '__main__':
    ...
    print("🤖 Bot is active with fully functional Back button layout!")
