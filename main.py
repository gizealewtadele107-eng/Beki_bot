...
async def handle_v(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if act == "v":
        ...
        if u:
            ...
            kb = ReplyKeyboardMarkup([["ሌላ እጣ ይቁረጡ"]], resize_keyboard=True)
            await context.bot.send_photo(uid, img, caption="በተሳካ ሁኔታ ተመዝግበዋል!\n🎉 መልካም እድል 🎉", reply_markup=kb)
...
if __name__ == '__main__':
    ...
    application.add_handler(ConversationHandler(
        ...
        states={
            ...
            BROADCAST: [MessageHandler((filters.TEXT | filters.PHOTO | filters.VIDEO) & ~filters.COMMAND, perform_broadcast)]
        },
